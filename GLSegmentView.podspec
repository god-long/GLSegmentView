#
#  Be sure to run `pod spec lint GLSegmentView.podspec' to ensure this is a
...
segment A segment view for title
  ...
  # s.author    = "god-long"
  # s.authors            = { "god-long" => "xulongios@126.com" }
  # s.social_media_url   = "http://twitter.com/god-long"
  ...
  s.source_files  = "GLSegmentView/*.{swift,xib}"
